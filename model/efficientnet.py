...
__all__ = ["efficientnet_b0", "efficientnet_b2"]
...
class _EfficientNetEncoder(nn.Module):
    ...
    def forward(self, x: Tensor, return_intermediate: bool = False) -> Tensor:
...
def _efficientnet_model(arch: str, inverted_residual_setting: List[MBConvConfig], dropout: float,
                        pretrained: bool, progress: bool, **kwargs: Any) -> _EfficientNetEncoder:
    model = _EfficientNetEncoder(arch, inverted_residual_setting, dropout, **kwargs)
    if pretrained:
...
def efficientnet_b0(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> _EfficientNetEncoder:
    """
...
def efficientnet_b2(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> _EfficientNetEncoder:
    """
