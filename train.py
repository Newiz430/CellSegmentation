...
schedulers = {
    'OneCycleLR': OneCycleLR(optimizer, max_lr=args.lr, epochs=args.epochs,
...
def save_model(single_branch, epoch, model, optimizer, scheduler, output_path):
    ...
    if single_branch is None:
        ...
        single_branch = '_' + single_branch
    torch.save(obj, os.path.join(output_path, 'checkpoint_{}epochs{}.pth'.format(epoch, single_branch)))
