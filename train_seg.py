...
from train import train_seg, DiceLoss
...
print("Training Mode: {} | Device: {} | Model: {} | {} epoch(s) in total | {} | Initial LR: {} | Output directory: {}"
...
def train(total_epochs, last_epoch, test_every, model, crit_seg, optimizer, scheduler, output_path):
